...
public class SettingsActivity extends Activity implements OnClickListener {
	...
	/**
	 * Called when the activity is first created. Creates the user interface for the settings.
	 * 
	 * @param savedInstanceState It is used to save the state of the created Activity.
	 * 
	 * @author Yuriy Stanchev
	 * 
	 * @email i_stanchev@ml1.net
