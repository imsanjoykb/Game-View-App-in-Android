...
public class Menu extends Activity implements OnClickListener {
	...
	/***
	 * Scoreninja Game: Overflow Your app id and private key are
	 * "overflow2013ldboard2" and "". You must
	 * pass these to the ScoreNinjaAdapter constructor. Keep the private key
	 * safe! If lost it cannot be retrieved, and if made public unauthorized
	 * scores may be submitted.
	 * 
	 */
	//public static ScoreNinjaAdapter scoreNinjaAdapter;
...
//		Button leaderboardButton = (Button) findViewById(R.id.bLeaderboard);
...
//		leaderboardButton.setOnClickListener(this);
		...
		/*
		 * Initialize the ScoreNinja Adapter.
		 */
//		scoreNinjaAdapter = new ScoreNinjaAdapter(
//
//		this, "overflow2013ldboard2",
//				"");
...
//			ScoreNinjaAdapter scores = new ScoreNinjaAdapter(this, "overflow2013ldboard2", "");
//			scores.show(-1);
//			break;
		}
	}
